...
class LanguageAdaptersCategorias2(var context: Context, var arrayList: ArrayList<Categorias_object>):BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        var view: View = View.inflate(context, R.layout.card_view_item_grid2, null)
